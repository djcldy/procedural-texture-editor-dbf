...
async function ProceduralTexture(solution, textures, scene) {
  ...
  const promiseArray = parsedTextures.map((o) => GenerateTexture(o));
  ...
  //cache is generated at this point
...
async function submitFacadeRule() {
  ...
  await ProceduralTexture(sampleSolution, [tex1, tex2, tex3], scene);
