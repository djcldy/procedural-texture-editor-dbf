...
const loadImage = async (context, canvas, src) => {
...
let CurtainWall = function (diffuse) {
  let obj = {};
...
let Horizontal = function ({ color, width, t }) {
  let obj = {};
...
let MullionVertical = function ({ color, width, start, end }) {
  let obj = {};
...
let MullionHorizontal = function ({ color, width, start, end }) {
  let obj = {};
...
let Replace = function (rules, optional) {
...
let RandomHorizontal = function ({ color, width, probability }) {
  let obj = {};
...
let StripWindow = function ({ color, x1, y1, x2, y2 }) {
  let obj = {};
...
let PunchMullion = function ({ color, top, bottom, left, right, width, subDiv, repeat }) {
  let obj = {};
...
let PunchWindow = function ({ color, top, bottom, left, right, repeat }) {
  let obj = {};
...
let StripMullion = function ({ color, width, x1, y1, x2, y2, subDiv }) {
  let obj = {};
...
let Frame = function ({ color, width, x1, y1, x2, y2 }) {
  let obj = {};
